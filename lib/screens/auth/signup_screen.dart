      ...
      formChild: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Set up your clinic workspace in a few simple steps.',
            ...
            CustomDropdownField<String>(
              ...
              items: const [
                DropdownMenuItem(
                  value: 'vetbridge_main_chain',
                  child: Text('VetBridge Main Chain'),
                ),
              ],
              onChanged: (value) => setState(() => _clinic = value),
              validator: (value) => value == null ? 'Select a clinic' : null,
            ),
            const SizedBox(height: 14),
            CustomDropdownField<String>(
              label: 'Branch',
              ...
              items: const [
                DropdownMenuItem(
                  value: 'central_clinic',
                  child: Text('Central Clinic'),
                ),
                DropdownMenuItem(
                  value: 'north_clinic',
                  child: Text('North Clinic'),
                ),
                DropdownMenuItem(
                  value: 'south_clinic',
                  child: Text('South Clinic'),
                ),
              ],
